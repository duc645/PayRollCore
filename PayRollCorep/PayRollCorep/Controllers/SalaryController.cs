...
namespace PayRollCorep.Controllers
{
    public class SalaryController : Controller
    {
        ...
        public IActionResult GrossSalaryToNet()
        {
            return View();
        }
        [HttpPost]
        public IActionResult GrossSalaryToNet(Salary model)
        {
        ...
        public IActionResult NetSalaryToGross()
        {
            return View();
        }
        [HttpPost]
        public IActionResult NetSalaryToGross(Salary model)
        {
